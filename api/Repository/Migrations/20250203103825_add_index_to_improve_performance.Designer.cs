...
namespace api.Migrations
{
    ...
    [Migration("20250203103825_add_index_to_improve_performance")]
    partial class add_index_to_improve_performance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Customer", b =>
                {
                    ...
                    b.ToTable("Customer", t =>
                        {
                            t.HasTrigger("trg_AuditCustomer");
                        });
            ...
            modelBuilder.Entity("api.Models.ReceiptDetails", b =>
                {
                    ...
                    b.ToTable("ReceiptDetails", t =>
                        {
                            t.HasTrigger("trg_UpdateProductStock");
                        });

                    b.HasAnnotation("SqlServer:UseSqlOutputClause", false);
                });

            modelBuilder.Entity("api.Models.ReceiptOverview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
